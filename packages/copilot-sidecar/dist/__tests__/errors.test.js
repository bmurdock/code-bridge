...
import { BridgeError, normalizeBridgeError, coerceBridgeError, summarizeErrorDetails } from '../errors';
describe('errors utilities', () => {
    ...
    it('extracts details from JSON payloads', () => {
        const normalized = normalizeBridgeError(400, JSON.stringify({ error: 'Invalid request payload', details: [{ path: 'prompt' }] }));
