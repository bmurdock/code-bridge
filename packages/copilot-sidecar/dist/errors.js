export class BridgeError extends Error {
    ...
    body;
    details;
    constructor(statusCode, message, body, details) {
        super(message);
...
export function normalizeBridgeError(status, responseText) {
...
export function coerceBridgeError(error) {
    ...
    if (Array.isArray(details)) {
        const parts = details
            ...
            if (entry && typeof entry === 'object') {
                const path = 'path' in entry ? String(entry.path) : undefined;
